...
class AdminSermonController extends Controller
{
	...
	{
		//
		$sermons = Sermon::query()->with("categorySermon")->get();
	...
	{
		$categorySermons = CategorySermon::all();
		return view("admin.sermons.create",['categorySermons'=>$categorySermons]);
	}
	...
	public function edit($id)
	{
		...
		$categorySermons = CategorySermon::all();
		return view("admin.sermons.edit", compact("sermon","categorySermons"));
	}
