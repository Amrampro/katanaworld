<section id="home" class="video-hero js-fullheight"
   style="height:400px;background:url({{asset('images/xbg_1.jpg.pagespeed.ic.iqKPxttw_o.jpg')}});background-size:cover;background-position:center center;background-attachment:fixed"
    data-section="home">
