...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
        ...
        <li @class(["nav-item menu-items my-2","active"=>Route::is("admin.sermonCategories.*")])>
			<a class="nav-link" href="{{ route('admin.sermonCategories.index') }}">
                <span class="menu-icon">
                    <i class="mdi mdi-arrow-right-bold-hexagon-outline"></i>
                </span>
				<span class="menu-title">Categories Sermon</span>
			</a>
		</li>
        ...
        <li @class(["nav-item menu-items my-2","active"=>Route::is("admin.prayers.*")])>
			<a class="nav-link" href="{{ route('admin.prayers.index') }}">
                <span class="menu-icon">
                    <i class="mdi mdi-arrow-right-bold-hexagon-outline"></i>
                </span>
				<span class="menu-title">Prières</span>
			</a>
		</li>
