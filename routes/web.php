...
// use App\Http\Controllers\Admin\AdminPrayerController;
use App\Http\Controllers\AdminPrayerController;
...
// Home
	...
	Route::get("/free_bible", [HomeController::class, "free_bible"])->name("free_bible");

	Route::get("/prayer", [HomeController::class, "prayer"])->name("prayer");
	Route::POST("/prayer/store", [HomeController::class, "prayer_store"])->name("prayer/store");
...
// Livres
	...
	Route::group(["as" => "admin.", "prefix" => "kt-admin", "middleware" => "auth.admin"], function () {
		...
		Route::resource("prayers", AdminPrayerController::class);
		...
		Route::resource("sermonCategories", CategorieSermonController::class);
